		...
		public override void Reload()
		{
			...
			using (var reader = new BinaryReader(stream))
			{
				...
				for (int x = 0; x < 255; x++)
				{
					...
					var behaviorID = reader.ReadBytes(3);

					indexedBehaviors.Nodes.Add(x.ToString("X2") + ": " + string.Join(string.Empty, behaviorID.Reverse().Select(y => y.ToString("X2"))) + " Object: " + objectIndex.ToString("X2"));
				}
			}
